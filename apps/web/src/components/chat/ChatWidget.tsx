                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-1">
                          ...
                          {info.supportsTools && (
                            <span className="text-[10px] px-1 py-0.5 bg-green-100 text-green-700 rounded">acoes</span>
                          )}
                        </div>
        ...
        {!currentModel?.supportsTools && (
          <div className="px-4 py-2 bg-amber-50 border-b border-amber-100 flex items-center gap-2">
            ...
            <p className="text-xs text-amber-700">
              Este modelo e apenas para conversa. Para criar tarefas/eventos, use Claude ou GPT.
            </p>
          </div>
        )}
            ...
            <div className="h-full flex flex-col items-center justify-center text-center px-4">
              ...
              <p className="text-sm text-gray-500 mb-4">
                {currentModel?.supportsTools
                  ...
                  : 'Este modelo e apenas para conversa. Mude para Claude ou GPT para criar tarefas.'}
              </p>
