...
Este diretório contém as stories detalhadas do projeto NCIAFlux, organizadas por épico.
...
|---|-------|------------|--------|
| 1.1 | [Setup do Projeto](./1.1-setup-projeto.md) | P0 | Draft |
| 1.2 | [Autenticação](./1.2-autenticacao.md) | P0 | Draft |
| 1.3 | [Questionário de Descoberta](./1.3-questionario-descoberta.md) | P0 | Draft |
| 1.4 | [Motor de Perfil](./1.4-motor-perfil.md) | P0 | Draft |
| 1.5 | [Resultado da Descoberta](./1.5-resultado-descoberta.md) | P0 | Draft |
| 1.6 | [Descoberta sem Cadastro](./1.6-descoberta-sem-cadastro.md) | P0 | Draft |
...
| # | Story | Prioridade | Status |
|---|-------|------------|--------|
| 2.1 | [Estrutura de Planos](./2.1-estrutura-planos.md) | P0 | Draft |
| 2.2 | [Geração de Plano](./2.2-geracao-plano.md) | P0 | Draft |
| 2.3 | [Dashboard](./2.3-painel-dashboard.md) | P0 | Draft |
| 2.4 | Rotinas Condicionais | P1 | Pendente |
| 2.5 | Técnicas Adaptativas | P1 | Pendente |
...
| # | Story | Prioridade | Status |
|---|-------|------------|--------|
| 3.1 | [Chat de Acompanhamento](./3.1-chat-acompanhamento.md) | P0 | Draft |
| 3.2 | Sistema de Check-ins | P0 | Pendente |
| 3.3 | Notificações Básico | P0 | Pendente |
| 3.4 | Config Notificações | P1 | Pendente |
| 3.5 | Motor de Adaptação | P1 | Pendente |
...
| # | Story | Prioridade | Status |
|---|-------|------------|--------|
| 4.1 | Micro-Recompensas | P1 | Pendente |
| 4.2 | Celebrações | P1 | Pendente |
| 4.3 | Widgets | P1 | Pendente |
| 4.4 | [Modo Crise](./4.4-modo-crise.md) | P0 | Draft |
...
| # | Story | Prioridade | Status |
|---|-------|------------|--------|
| 5.1 | Biblioteca Relatórios | P2 | Pendente |
| 5.2 | Chat por Voz | P2 | Pendente |
| 5.3 | Conteúdo Educativo | P2 | Pendente |
| 5.4 | Comunidade | P2 | Pendente |
...
| # | Story | Prioridade | Status |
|---|-------|------------|--------|
| 6.1 | Vinculação Profissional | P3 | Pendente |
| 6.2 | Dashboard Profissional | P3 | Pendente |
| 6.3 | Relatórios Profissional | P3 | Pendente |
...
- **P1**: MVP - Importante para experiência completa
- **P2**: Pós-MVP - Plano Avançado
- **P3**: Pós-MVP - Plano Profissional

## Status das Stories

- 📝 **Draft**: Story documentada, aguardando aprovação
- ✅ **Approved**: Aprovada para desenvolvimento
...
*Gerado pelo PO seguindo BMad Method v4.44.3*
